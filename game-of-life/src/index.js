...
// if the cell id dead it is only going to change to 1 if it
// has 3 live neighbors. else it stays a 0.
// 1 is going to stay a 1 if it has less than 2 lives
// or greater than 3 lives.

// reproduction happens with exactly 3 neighbors
